    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _q2.default.nfcall(_child_process.exec, 'mkdir "' + $install('/src') + '"');

          case 2:
            _context.next = 4;
            return (0, _utils.wget)('YMFE/yicon#deploy', $install('/src'));
        ...
        switch (_context7.prev = _context7.next) {
          ...
          case 4:
            ...
            return new Promise(function (resolve, reject) {
              ...
              var bar = new _progress2.default('依赖安装中 [:bar] :percent', {
                total: total,
...
var buildProject = function () {
    ...
    return _regenerator2.default.wrap(function _callee9$(_context9) {
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            cmd = (0, _child_process.spawn)('npm', ['run', 'build'], { cwd: $install('/src') });
            _context9.next = 3;
            return (0, _utils.loadingSpawn)(cmd, '构建项目');
  ...
  return function buildProject() {
    return _ref13.apply(this, arguments);
  };
}();

exports.default = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee10() {
  var config;
    ...
    while (1) {
      switch (_context10.prev = _context10.next) {
        ...
        case 22:
          ...
          _utils.log.error(_context10.t0.message);
          process.exit(1);
